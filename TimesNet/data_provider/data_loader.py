...
class Dataset_ETT_hour(Dataset):
    ...
    def __read_data__(self):
        ...
        if self.set_type == 0 and self.args.augmentation_ratio > 0:
            self.data_x1, self.data_y, augmentation_tags = run_augmentation_single(self.data_x1, self.data_y, self.args)
    ...
    def __getitem__(self, index):
        ...
        return seq_x_tensor,aux_tensor, seq_y, seq_x_mark,aux_mark, seq_y_mark
