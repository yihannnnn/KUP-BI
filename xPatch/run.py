...
parser.add_argument('--CalphaC',  type=float, default=0.5)
parser.add_argument( '--use_dynamic_gate', type=int, default=0, choices=[0, 1], help='0: use static per-channel gate (default); 1: use dynamic statistics-based gate' )
